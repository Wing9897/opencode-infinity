...
const MESSAGES = {
    'zh-TW': {
        ...
        logClear: '清除日誌',
        logCopy: '複製日誌',
        toastLogsCopied: '日誌已複製',
        toastLogsCopyFailed: '複製失敗（尚無日誌）',
        ...
        labelSwitchStrategy: '切換策略',
        switchStrategyAuto: '自動',
        switchStrategyToken: 'Token 閾值',
        switchStrategyRounds: '輪次',
    ...
    en: {
        ...
        toastLogsCopyFailed: 'Nothing to copy',
        ...
        labelSwitchStrategy: 'Switch strategy',
        switchStrategyAuto: 'Auto',
        switchStrategyToken: 'Token threshold',
        switchStrategyRounds: 'Rounds',
