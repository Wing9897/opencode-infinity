...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "err_read_failed": "讀取失敗：{error}",
        "err_yaml_invalid": "YAML 格式無效：{error}",
        "err_write_failed": "寫入失敗：{error}",
        "err_yaml_parse_failed": "YAML 解析失敗：{error}",
        "err_no_config": "未指定設定檔",
        "err_session_id_invalid": "session_id 格式不正確",
        "err_config_not_found": "找不到設定檔：{name}",
    ...
    "en": {
        ...
        "err_read_failed": "Read failed: {error}",
        "err_yaml_invalid": "Invalid YAML: {error}",
        "err_write_failed": "Write failed: {error}",
        "err_yaml_parse_failed": "YAML parse failed: {error}",
        "err_no_config": "No config selected",
        "err_session_id_invalid": "Invalid session_id format",
        "err_config_not_found": "Config not found: {name}",
